...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-4 border-orange-500 dark:border-orange-600 text-sm font-bold leading-5 text-gray-100 dark:text-gray-100 focus:outline-none focus:border-orange-700 transition duration-150 ease-in-out'
